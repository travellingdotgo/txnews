...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	...
	protected boolean isReadyForPullEnd() {
		float exactContentHeight = /*FloatMath.floor*/(float)Math.floor(mRefreshableView.getContentHeight() * mRefreshableView.getScale());
	...
	final class InternalWebViewSDK9 extends WebView {
		...
		private int getScrollRange() {
			return (int) Math.max(0, /*FloatMath.floor*/Math.floor(mRefreshableView.getContentHeight() * mRefreshableView.getScale())
